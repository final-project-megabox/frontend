...
export class MovieRankComponent implements OnInit {
  ...
  ngOnInit() {
    this.RankMovies = [
      ...
      { id: 4, age: 'age-all', title: '나랏말싸미', reservationRate: '70', releaseDate: '2019-07-24', url: 'http://image2.megabox.co.kr/mop/poster/2019/F5/A1A99E-025A-4874-B479-1597994D94A8.large.jpg' },
